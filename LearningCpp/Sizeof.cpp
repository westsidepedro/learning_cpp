 	...
 	for (int i = 0; i < 5; i++)					//get numbers from MultiArray
 	 {
 	 	...
 	 	cout << "   row #" << i << endl;
 	 	cout << "   size of MultiArray = " << sizeof(MultiArray[i]) << "bytes" << endl; 
 	 	cout << "   colums of MultiArray = " << sizeof(MultiArray[i])/4 << endl; // 4bytes per int
 	 	cout << endl;
 	 }
...
cout << "---------------------New example with Strings---------------------" << endl;
