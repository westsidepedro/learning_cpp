...
int main()
 ...
 /*	int values[3]; // values[0,1,2]
 	...
 	float number[4] = {4.5 , 2.3, 7.2 , 8.1};
 	...
 	for(int i = 0; i < 3 ; i++ )
 	 {
 	 	cout << "Number stored in position " << i << " of Array 'values' is:" << values[i] << endl;	
 	 }
	...
	for(int i = 0; i < 4 ; i++ )
 	 {
 	 	cout << "Number stored in position " << i << " of Array 'number' is:" << values[i] << endl;	
 	 }
